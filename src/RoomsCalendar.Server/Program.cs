        ...
        public static void Main(string[] args)
        {
            ...
            // Configure services.
            {
                ...
                services
                    ...
                    .AddKeyedSingleton<IRoomsProvider, RoomsAndEventsProvider>(RoomProviderNames.ClubRoomFromKnoq, (sp, _) => sp.GetRequiredService<RoomsAndEventsProvider>());
                services
                    ...
                    .AddKeyedSingleton<IRoomsProvider, TitechRoomsProvider>(RoomProviderNames.TitechReserved, (sp, _) => sp.GetRequiredService<TitechRoomsProvider>());
